...
void CFiguras::castillo(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::miprisma(GLuint textura1, float rep)  //Funcion creacion prisma
{
	...
	glTexCoord2f(rep, 0.0f); glVertex3fv(vertice[0]); // 4
	glTexCoord2f(rep, rep); glVertex3fv(vertice[4]); // 7
	glTexCoord2f(0.0f, rep); glVertex3fv(vertice[7]); // 1
	glEnd();
	...
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(rep, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(rep, rep); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, rep); glVertex3fv(vertice[4]);
	glEnd();
	...
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(rep, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(rep, rep); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, rep); glVertex3fv(vertice[2]);
	glEnd();
	...
	glTexCoord2f(rep, 0.0f); glVertex3fv(vertice[6]); // 7  //recorrí los vertices
	glTexCoord2f(rep, rep); glVertex3fv(vertice[2]); // 6
	glTexCoord2f(0.0f, rep); glVertex3fv(vertice[1]); // 2
	glEnd();
	...
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(rep, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(rep, rep); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, rep); glVertex3fv(vertice[3]);
	glEnd();

	glBindTexture(GL_TEXTURE_2D, textura1);   // choose the texture to use.
	glBegin(GL_POLYGON);  //Top
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(rep, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(rep, rep); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0, rep); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[7]);
	glEnd();
}